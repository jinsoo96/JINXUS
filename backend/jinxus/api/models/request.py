...
class TaskRequest(BaseModel):
    ...
    autonomous: bool = Field(default=False, description="자율 멀티스텝 모드")
    max_steps: int = Field(default=10, ge=2, le=20, description="자율 모드 최대 단계")
    timeout_seconds: int = Field(default=14400, ge=60, le=86400, description="타임아웃(초)")

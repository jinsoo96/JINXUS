...
def check_and_trigger_reflection(
    ...
    """
    try:
        # 최근 메모리 조회 (task_result만)
        recent = long_term_memory.get_recent_memories(
            agent_name, limit=REFLECTION_MEMORY_COUNT, node_type="task_result"
        )
